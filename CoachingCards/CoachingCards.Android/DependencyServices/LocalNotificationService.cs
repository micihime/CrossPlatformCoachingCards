...
using CoachingCards.Droid.DependencyServices;
...
namespace CoachingCards.Droid.DependencyServices
{
    public class LocalNotificationService : ILocalNotificationService
    {
        ...
        public void LocalNotification(string title, string body, int id, DateTime notifyTime)
        {
            ...
            {
                localNotification.IconId = Resource.Drawable.notification_bg_normal;
            }
    ...
    public class ScheduledAlarmHandler : BroadcastReceiver
    {
        ...
        public override void OnReceive(Context context, Intent intent)
        {
            ...
            var stackBuilder = Android.App.TaskStackBuilder.Create(Application.Context);
